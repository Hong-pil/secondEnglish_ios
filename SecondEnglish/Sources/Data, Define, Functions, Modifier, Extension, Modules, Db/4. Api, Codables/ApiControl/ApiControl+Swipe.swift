...
extension ApiControl {
    ...
    static func getMyCategoryProgress(uid: String, isExpiredAccessToken: @escaping()->Void={}) -> AnyPublisher<MyLearningProgressResponse, ErrorModel> {
        Future<MyLearningProgressResponse, ErrorModel> { promise in
            
            let apis: ApisSwipe = .myCategoryProgress(uid: uid)
...
//                    //error check end --------------------------------------------------------------------------------
    ...
    static func getMyCardList(uid: String, isExpiredAccessToken: @escaping()->Void={}) -> AnyPublisher<MyCardResponse, ErrorModel> {
        Future<MyCardResponse, ErrorModel> { promise in
            
            let apis: ApisSwipe = .myCardList(uid: uid)
