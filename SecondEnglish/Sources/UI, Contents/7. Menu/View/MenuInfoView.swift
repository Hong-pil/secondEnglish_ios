...
//                    }
                    ...
                    ZStack {
                        Button {
                            ...
                            .frame(width: geo.size.width/sizeInfo.itemCount)
                        }
                        .buttonStyle(.borderless)
                        
                        VerticalDivider(color: Color.gray400, width: sizeInfo.dividerWidth)
                            .opacity(0.12)
                            .padding(EdgeInsets(top: sizeInfo.dividerPadding, leading: geo.size.width/sizeInfo.itemCount - sizeInfo.dividerWidth, bottom: sizeInfo.dividerPadding, trailing: 0.0))
                    }
