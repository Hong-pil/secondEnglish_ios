    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            CustomTextField(
                ...
                placeholder: "b_password_setting".localized,
                type: .Security
            )
            ...
            CustomTextField(
                ...
                correctStatus: $passwordConfirmCorrectStatus,
                isKeyboardEnter: $isKeyboardEnter,
                isFocused: .constant(false),
                placeholder: "b_confirm_password".localized,
                type: .Security
            )
                .frame(maxWidth: .infinity)
                .frame(height: sizeInfo.inputHeight)
...
#Preview {
    JoinPasswordPage(email: "hpk4981@gmail.com")
}
