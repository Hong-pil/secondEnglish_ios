...
extension PopupManager {
    static func present(_ popup: some Popup, must: Bool = false) { DispatchQueue.main.async { withAnimation(nil) {
        shared.views.append(popup, if: must ? must : canBeInserted(popup))
    }}}
}
