    ...
    func body(content: Content) -> some View {
        content
            .popup(isPresented: $isPresented) {
                AlertView(isPresented: $isPresented, buttonIndex: $buttonIndex, type: type, title: title, message: message, detailMessage: detailMessage, fanitMessage: fanitMessage, buttons: buttons)
            } customize: {
                $0
                    .type(.default)
                    .position(.top)
...
extension View {
    func showAlertSimple(
        ...
        onClick:@escaping(Int) -> Void) -> some View {
            modifier(AlertViewModifier(isPresented: isPresented, type: type, title: title, message: message, buttons: [], detailMessage: detailMessage, fanitMessage: fanitMessage, onClick: onClick))
        }
    ...
    func showAlert(
        ...
        buttons:[String],
        onClick:@escaping(Int) -> Void) -> some View {
            modifier(AlertViewModifier(isPresented: isPresented, type: type, title: title, message: message, buttons: buttons, detailMessage: detailMessage, fanitMessage: fanitMessage, onClick: onClick))
        }
}
